...
Point it at a file path to humanize documents or code:

```
/humanizer report/report.tex
```

```
/humanizer src/main.py
```

Output goes to `report.humanized.tex` / `main.humanized.py`, preserving the original.
